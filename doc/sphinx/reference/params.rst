...
hashtable_buckets
	...
	The number of buckets in lookup hashtable. Increase this value if the number of lookup collisions (n_htb_lookup_collisions) grows faster than the number of requests.
